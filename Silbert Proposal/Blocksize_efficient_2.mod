...
Model Name:         Blocksize_efficient_2.mod
Model Description:  
...
Trace Events:       Init,Trace,Half,HF
Hide Edges:         
...
Size:          1
     ...
     Vertex #1
Name:             Init
Description:      Initialize variables. Set mem pool to 1000, blockchain size to 110,000 MB, define M, capacity at 3.7Mb, Block reward of 12.5 BTC
State Changes:    T=1000,B=110000,M=3700000,C=12.5
Parameter(s):     
Bitmap(Inactive): 
Bitmap(Active):   
...
Use Flowchart Shapes:   0
Use Opaque Bitmaps:   0
Location:         X:  2.03;  Y:  1.02;  Z: -1.00;
Local Trace:      
Trace Location:   Bottom

     Vertex #6
Name:             HF
Description:      Hardfork to double capacity in 12 months
State Changes:    M=M*2
Parameter(s):     
Bitmap(Inactive): 
Bitmap(Active):   
...
Attributes:    
  ...
  Sub-Edge #9
Description:   Schedule 2x HF in 12 months
Type:          Scheduling
Origin:        Init
Destination:   HF
Condition:     1==1
