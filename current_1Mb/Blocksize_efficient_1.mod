...
Model Name:         Blocksize_efficient_1.mod
Model Description:  
...
Size:          1
     ...
     Vertex #1
Name:             Init
Description:      Initialize variables. Set mem pool to 1000, blockchain size to 110,000 MB, define M, capacity at 1Mb, Block reward of 12.5 BTC
State Changes:    T=1000,B=110000,M=1000000,C=12.5
Parameter(s):     
Bitmap(Inactive): 
Bitmap(Active):   
